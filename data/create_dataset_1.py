...
def get_balanced_video_list_by_source(video_files, max_per_class=200):           
    ...
    for video_file in video_files:      
        ...
        for part in path_parts:      
            if part in ['climb-over-fence', 'damage-to-facilities', 'damage-to-fence', 'facility-filming', 'normal']:      
                category = part      
                break      
...
for video_file in selected_videos:      
    ...
    if 'damage-to-facilities' in category or 'damage-to-fence' in category:      
        ...
        default_label = 1  # UnauthorizedFilming  
    elif 'climb-over-fence' in category:      
        default_label = 2  # ClimbOverFence  
    elif 'normal' in category:     
        default_label = 3  # Normal  
    else:      
        continue      
